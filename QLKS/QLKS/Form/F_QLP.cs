...
namespace QLKS
{
    public partial class F_QLP : Form
    {
        ...
        private void getdataview()
        {
            ...
            F_QLP_V.Columns[4].HeaderText = "Mã nhân viên";
            //F_QLP_V.column
        ...
        private void RefreshData()
        {
            ...
            {
                DataRowView row = (DataRowView)cb_manv.Items[i];
                if (row["MaNV"].ToString() == F_QLP_V.CurrentRow.Cells[4].Value.ToString())
                {
            ...
            //int index = cb_manv.Items.IndexOf(F_QLP_V.CurrentRow.Cells[4].Value.ToString());
            //cb_manv.SelectedIndex = index;
